...
# CHALLENGE III
SELECT a.au_id AS AUTHOR_ID, a.au_lname AS LAST_NAME, a.au_fname AS FIRST_NAME, SUM(s.qty) AS TOTAL_SALES
FROM authors as a
LEFT JOIN titleauthor as au
ON a.au_id = au.au_id
LEFT JOIN titles as t
...
# CHALLENGE IV
SELECT a.au_id AS AUTHOR_ID, a.au_lname AS LAST_NAME, a.au_fname AS FIRST_NAME, IFNULL(SUM(s.qty), 0) AS TOTAL_SALES
FROM authors as a
LEFT JOIN titleauthor as au
ON a.au_id = au.au_id
LEFT JOIN titles as t
